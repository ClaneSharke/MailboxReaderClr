...
namespace EwsToSqlSync
{
    ...
    /// Same code as MailboxReaderClr's JsonMini.cs (SQL Server's CLR host doesn't trust
    /// System.Web.Extensions, which is what motivated writing this in the first place) --
    /// kept here too so this standalone project has zero external NuGet dependencies,
    /// matching the rest of the repo. Used here to parse config.json.
    ///
